...
urlpatterns = [
    ...
    path('notification-settings/', views.get_notification_settings, name='get_notification_settings'),
    path('notification-settings/update/', views.update_notification_settings, name='update_notification_settings'),
]
