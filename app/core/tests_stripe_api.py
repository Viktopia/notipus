...
class StripeAPITest(TestCase):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_api_error(self, mock_create):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_card_error(self, mock_create):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_rate_limit_error(self, mock_create):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_authentication_error(self, mock_create):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_permission_error(self, mock_create):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_general_exception(self, mock_create):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_with_metadata(self, mock_create):
    ...
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_with_address(self, mock_create):
    ...
    def test_create_stripe_customer_logs_stripe_error(self, mock_logger, mock_create):
        ...
        self.assertIsNone(result)
        mock_logger.error.assert_called_once_with(f"Stripe error creating customer: {error_msg}")

    @patch('core.services.stripe.stripe.Customer.create')
    @patch('core.services.stripe.logger')
    def test_create_stripe_customer_logs_general_error(self, mock_logger, mock_create):
        ...
        self.assertIsNone(result)
        mock_logger.error.assert_called_once_with(f"Unexpected error creating Stripe customer: {error_msg}")

    @patch('core.services.stripe.settings.STRIPE_SECRET_KEY', 'sk_test_new_key')
    @patch('core.services.stripe.stripe.Customer.create')
    def test_create_stripe_customer_uses_correct_api_key(self, mock_create):
